...
class get_datasets(Dataset):
    ...
    def __init__(self, args, names, labels):
        ...
        MODEL_DATASET_MAP = {
            ...
            'memocmt_v16': Data_Feat,
            'memocmt_v17': Data_Feat,
            'memocmt_v18': Data_Feat,
            'memocmt_v19': Data_Feat,
            'memocmt_v20': Data_Feat,
            'memocmt_v21': Data_Feat,
            'memocmt_v22': Data_Feat,
            'memocmt_v23': Data_Feat,
            'memocmt_v24': Data_Feat,
            'memocmt_v25': Data_Feat,
            'memocmt_v26': Data_Feat,
            'memocmt_v27': Data_Feat,
        }
